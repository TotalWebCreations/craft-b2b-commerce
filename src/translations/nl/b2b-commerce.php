...
return [
    ...
    'Offer pay on account (on invoice) at checkout for approved companies, within their credit limit. The pay-on-account gateway ships in an upcoming release; this toggle governs its availability once it does.' => 'Bied bij het afrekenen betaling op rekening (op factuur) aan voor goedgekeurde bedrijven, binnen hun kredietlimiet. De betaal-op-rekening-gateway verschijnt in een toekomstige release; deze schakelaar bepaalt de beschikbaarheid ervan zodra dat het geval is.',
